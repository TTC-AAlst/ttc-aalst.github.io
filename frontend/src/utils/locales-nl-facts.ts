export default {
  ...
  serviceSectionOneComponentFive:
    ' – Het is de enige slag die je bij het tafeltennissen maakt waar je volledige controle hebt over de bal zonder dat je tegenstander er op enige wijze invloed op uit kan oefenen. Jij bepaald dus volledig wat er gebeurt en hier kun je een belangrijk voordeel uit halen.',
  serviceSectionOneComponentSix: 'Frequentie',
  serviceSectionOneComponentSeven:
    ' – Zoals al eerder gemeld, ieder punt begint met een service en het is daarmee dus een veel voorkomende slag. Afhankelijk van jouw eigen type spel en dat van je tegenstander kan het zijn dat meer dan 20% van de slagen services zijn.',
  serviceSectionOneComponentEight: 'Vervolg',
  serviceSectionOneComponentNine:
    ' – Met een sterke service kun je behoorlijk wat invloed hebben op de wijze en de plaats waar de return gespeeld wordt. Hierdoor kun je door dit af te stemmen op de rest van je spel de service zo spelen dat je jouw eigen sterke 3e en 5e slag in stelling kan brengen.',
  serviceSectionOneComponentTen: 'Druk',
  serviceSectionOneComponentEleven:
    ' – Een speler die zich bewust is van het feit dat zijn tegenstander een sterkere service heeft voelt vanaf de start van de rally de druk hiervan, zelfs als hij zelf moet serveren. Omgekeerd geldt dat het hebben van een sterkere service vaak betekend dat je iets meer relaxed achter de tafel staat.',
  serviceSectionOneComponentTwelve: 'Kennis',
  serviceSectionOneComponentThirteen:
    ' – Het hebben van  een sterke service (liefst verschillende) betekent vaak dat je ook beter in staat bent om de service van je tegenstander te beoordelen en te retourneren.',
  serviceSectionOneComponentFourteen: 'Waaruit bestaat een goede service?',
  serviceSectionOneComponentFifteen:
  ...
  serviceSectionOneComponentTwenty:
  ...
  serviceSectionOneComponentTwentyOne:
  ...
  serviceSectionOneComponentTwentySix:
  ...
  serviceSectionOneComponentTwentySeven:
  ...
  serviceSectionOneComponentTwentyEight:
  ...
  serviceSectionTwoComponentTwo:
    'Een persoon speelt met lange noppen omdat hij (meestal) een zwakke Backhand heeft en met noppen dit tracht te verdoezelen. Natuurlijk zijn er ook B-spelers die zeer goed noppen hanteren..',
  serviceSectionTwoComponentThree:
    'Lange noppen keren altijd het effect om wat jij ernaartoe slaat. Topspinnen naar noppen geeft dus backspin terug. Backspin naar noppen geeft dus Topspin terug',
  serviceSectionTwoComponentFour: 'Een verduidelijking kan je zien op volgende Engelstalige afbeelding:',
  serviceSectionTwoComponentFive:
  ...
  serviceSectionTwoComponentEight:
  ...
  serviceSectionTwoComponentNine:
    'Tegen lange noppen/antitop spelen is eigenlijk wel een kunst op zich.   Zolang er effect op de bal zit, is het voor een noppenspeler vrij gemakkelijk aangezien hij veel druk legt bij de tegenstander door het weerkerende effect van zijn noppen. Maar wanneer er gewoon contra (=zonder effect) gespeeld wordt is het voor de noppenspeler heel moeilijk om de bal te krijgen zonder er een aanvallende return op te krijgen... Bij antitop is de controle groter dan bij noppen maar je bent er wel veel beperkter mee. Met een noppen kan je een stopblok kort bij de tafel doen, bij antitop is dit al veel moeilijker. Iemand met antitop gaat meestal een topspin "choppen" van ver achter zijn tafel.',
  serviceSectionTwoComponentTen:
  ...
  serviceSectionThreeComponentNine:
    'Bij een keiharde afmaakslag kan de bal een snelheid van 250 km/u bereiken (das dus bij Louis :)) . Bij het duwen komt men slechts tot   25km/u  (das dus bij Gerdo :))',
  serviceSectionThreeComponentTen: 'Als de bal de bat raakt is deze slechts 1/1000 van een seconde in contact.',
  serviceSectionThreeComponentEleven:
    'Dat bij de topspinslag de bal per seconde 50 maal om zijn as draait, dit zijn 3000 rotaties per minuut . (das bij Jurgen :))',
  ...
  serviceSectionFourComponentThree:
  ...
  serviceSectionFourComponentFive:
    '(21/03-19/04): hier vinden we de aanvalsspeler bij uitstek. Hij/zij is snel, aggressief en heeft een uitstekende kampgeest. Hij is geen strateeg maar een tacticus. Hij is ook een beter enkel- dan dubbelspeler. Ploegwerk ligt hem niet zo. Bv. Vladimir Samsonov. Bij ons : Dirk VK',
  serviceSectionFourComponentSix: 'Stier',
  serviceSectionFourComponentSeven:
    '(20/04-20/05): hij is het type dat probeert om het spel te vertragen. Er zijn relatief weinig (top)spelers van dit sterrenbeeld . In principe zijn ze te traag voor het spel. Maar bedenk dat niemand enkel een sterrenbeeld heeft: de ascendant speelt ook een rol. Bv. Zoran Primorac.',
  serviceSectionFourComponentEight: 'Tweeling',
  serviceSectionFourComponentNine:
    '(21/05-20/06): zonder twijfel het teken met de grootste reactiessnelheid, en dus uitstekend geschikt voor tafeltennis. Tevens een prima dubbelpartner. Vb. Wang Liqin (huidig nr. 1 in de wereld bij de mannen, Jurg Rosskopf, Thierry Cabrera, bij ons: Lieven, verjaart op 20/06. en ook Geert',
  serviceSectionFourComponentTen: 'Kreeft',
  serviceSectionFourComponentEleven:
    '(21/06-22/07): ook de kreeft zal men niet vaak aantreffen in onze sport. De snelle reacties zijn er voor hem/haar te veel aan. Hij speelt wel graag dubbel. Bv. Philippe Saive. bij ons : Chiel',
  ...
  serviceSectionFourComponentFifteen:
    '(23/08-22/09): de ijverige, leergierige speler die altijd aan zichzelf werkt. Nooit tevreden over zichzelf. Snel en intelligent, maar niet zo stressbestendig als leeuw of schorpioen. Vb. Trinko Keen., bij ons : Jurgen, Willy',
