...
describe('collectPlayerGameResultsByMatch', () => {
  ...
  it('skips doubles games', () => {
    const matches = [createSyncedMatch(1, '2025-03-10T20:00:00', 1, [{ homePlayerId: 1, outPlayerId: 2, outcome: 'Won', isDoubles: true }])];
  ...
  it('skips games where the player is not involved', () => {
    const matches = [createSyncedMatch(1, '2025-03-10T20:00:00', 1, [{ homePlayerId: 99, outPlayerId: 2, outcome: 'Won' }])];
  ...
  it('sorts results by date descending (most recent first)', () => {
    const matches = [
      createSyncedMatch(1, '2025-03-10T20:00:00', 1, [{ homePlayerId: 1, outPlayerId: 2, outcome: 'Won' }]),
      createSyncedMatch(2, '2025-03-17T20:00:00', 1, [{ homePlayerId: 1, outPlayerId: 3, outcome: 'Lost' }]),
    ];
