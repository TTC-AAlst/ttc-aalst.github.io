...
import Facts from './locales-nl-facts';
...
export default {
  ...
  trans: {
    ...
    login: {
      title: "Aanmelden",
      introText:
        "Geef de eerste letter(s) van je voornaam in en selecteer jezelf uit de lijst",
    ...
    comp: {
      ...
      scoresheetFileName:
        "${frenoyId} Sporta ${teamCode} vs ${theirClub} ${theirTeam}.xlsx",
    },
    players: {
    ...
    match: {
      ...
      report: {
        ...
        commentsOpenFormConfirm: "Reageer",
    ...
    footer: {
      cookieNotice:
        "We gebruiken cookies om je de best mogelijke ervaring te bieden. Door verder te surfen op onze site gaat u akkoord met ons gebruik van cookies.", // eslint-disable-line
